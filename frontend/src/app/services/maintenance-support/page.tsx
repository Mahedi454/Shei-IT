...
import maintainceBannerDark from "@/assets/Maintaince-Banner-Dark.png";
import maintainceBannerLight from "@/assets/Maintaince-Banner-Light.png";
...
function MaintenanceSupportBanner() {
  ...
  return (
    <div className="relative hidden items-center justify-center md:flex md:justify-end">
      ...
      <div className="relative w-full max-w-[760px]">
        <Image
          src={bannerImage}
          alt="Maintenance and support service banner"
          priority
          quality={90}
