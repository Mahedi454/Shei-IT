...
import hostingCloudBannerDark from "@/assets/Hosting-Cloud-Banner-Dark.png";
import hostingCloudBannerLight from "@/assets/Hosting-Cloud-Banner-Light.png";
...
const stats = [
  ...
  { value: "10+", label: "Sites Hosted", icon: CloudUpload },
...
function HostingCloudBanner() {
  ...
  const bannerImage =
    mounted && theme === "dark"
      ? hostingCloudBannerDark
      : hostingCloudBannerLight;
  ...
  return (
    <div className="relative flex items-center justify-center lg:justify-end">
      ...
      <div className="relative w-full max-w-[760px]">
        <Image
          src={bannerImage}
          alt="Hosting and cloud service banner"
          priority
          quality={90}
        ...
        <div className="mx-auto w-11/12 max-w-[1440px]">
          <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr] lg:items-end">
            <div>
              ...
              <ServiceGradientHeading className="mt-3 text-[2.1rem] font-semibold leading-tight tracking-[-0.05em] text-[color:var(--foreground)] sm:text-[2.55rem]">Complete Hosting & Cloud Solutions</ServiceGradientHeading>
            </div>
      ...
      <section className="relative pb-12 lg:pb-14">
        <div className="mx-auto grid w-11/12 max-w-[1440px] gap-8 lg:grid-cols-[0.35fr_0.65fr] lg:items-start">
          <div>
            ...
            <ServiceGradientHeading className="mt-3 max-w-[26rem] text-[1.8rem] font-semibold leading-[1.12] tracking-[-0.05em] text-[color:var(--foreground)] sm:text-[2.25rem]">Infrastructure That Performs, Protects & Scales</ServiceGradientHeading>
        ...
        <div className="mx-auto w-11/12 max-w-[1440px]">
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-[0.9fr_1fr] lg:items-end">
            <div>
              ...
              <ServiceGradientHeading className="mt-3 max-w-[34rem] text-[2.1rem] font-semibold leading-tight tracking-[-0.05em] text-[color:var(--foreground)] sm:text-[2.55rem]">Modern Technologies for Powerful Hosting</ServiceGradientHeading>
            </div>
            <p className="max-w-[40rem] text-[15px] font-medium leading-8 text-[color:var(--muted-foreground)]">
